    ...
    <div class="container mx-auto flex max-w-6xl flex-wrap items-center justify-between">
      ...
      <div class="mt-2 sm:mt-0 sm:flex md:order-2">
        ...
        <template v-if="!authStore.isAuthenticated" >
          <RouterLink to="/auth/login" type="button" class="mr-3 hidden border border-blue-700 py-1.5 px-6 text-center text-sm font-medium text-blue-700 focus:outline-none focus:ring-4 focus:ring-blue-300 md:inline-block rounded-lg">Login</RouterLink>
