<template>
  <div class="flex w-screen h-screen text-gray-700">
	...
	<!-- Component Start -->
    <div class="flex flex-col items-center w-16 pb-4 overflow-auto border-r border-gray-300 min-w-[60px]">
        <RouterLink to="/admin" class="flex items-center justify-center flex-shrink-0 w-full h-16 bg-gray-300">
    ...
    <div class="flex flex-col flex-grow">
        <div class="flex items-center flex-shrink-0 h-16 px-8 border-b border-gray-300">
            <h1 class="text-lg font-medium">Hello, {{ authStore.username  }}</h1>
            ...
            <button class="relative ml-2 text-sm focus:outline-none group">
                ...
                <div class="absolute right-0 flex-col items-start hidden w-40 pb-1 bg-white border border-gray-300 shadow-lg group-focus:flex">
                    <a @click="authStore.logout" class="w-full px-4 py-2 text-left hover:bg-gray-300" href="#">Logout</a>
                </div>
            </button>
        </div>
